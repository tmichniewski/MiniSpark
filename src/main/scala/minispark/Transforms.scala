...
object Transforms {
   ...
   * @return Returns the transform instance to filter the Dataset.
   */
   ...
   * @return Returns the transform instance to select the given columns.
   */
   ...
   * @tparam T Type of input data.
   * @return Returns the transform instance to add the given column.
   */
   ...
   * @tparam T Type of input data.
   * @return Returns the transform instance to add the given columns.
   */
   ...
   * @tparam T Type of input data.
   * @return Returns the transform instance to drop the given columns.
   */
   ...
   * @tparam T Type of input data.
   * @return Returns the transform instance to rename the given column.
   */
   ...
   * @tparam T Type of input data.
   * @return Returns the transform instance to rename the given columns.
   */
   ...
   * @tparam T Type of input data.
   * @return Returns the transform instance to cast the given column.
   */
   ...
   * @tparam T Type of input data.
   * @return Returns the transform instance to cast the given columns.
   */
   ...
   * @tparam T Type of input data.
   * @tparam U Type of output data.
   * @return Returns the transform instance to flatMap the Dataset.
   */
   ...
   * @tparam T Type of input data.
   * @return Returns the transform instance to aggregate the Dataset.
   */
   ...
   * @tparam T Type of input and output data.
   * @return Returns the transform instance to union the given Datasets.
   */
   ...
   * @tparam T Type of input and output data.
   * @return Returns the transform instance to subtract the given Datasets.
   */
   ...
   * @tparam T Type of input and output data.
   * @return Returns the transform instance to intersect the given Datasets.
   */
   ...
   * @tparam T Type of input and output data.
   * @return Returns the transform instance to find delta of the given Datasets.
   */
   ...
   * @tparam T Type of input data.
   * @return Returns the transform instance to cross join the given Datasets.
   */
   ...
   * @tparam T Type of input data.
   * @return Returns the transform instance to inner join the given Datasets.
   */
   ...
   * @param columns Columns to make the equijoin on.
   * @tparam T Type of input data.
   * @return Returns the transform instance to left outer join the given Datasets.
   */
   ...
   * @param columns Columns to make the equijoin on.
   * @tparam T Type of input data.
   * @return Returns the transform instance to right outer join the given Datasets.
   */
   ...
   * @param columns Columns to make the equijoin on.
   * @tparam T Type of input data.
   * @return Returns the transform instance to full outer join the given Datasets.
   */
   ...
   * @return Returns the transform instance to cast the given Dataset.
   */
   ...
   *
   * @tparam T Type of input data.
   * @return Returns the transform instance to cache the given Dataset.
   */
   ...
   * @param columns Rest of the columns.
   * @tparam T Type of input and output data.
   * @return Returns the transform instance to sort the given Dataset.
   */
  ...
  /**
   * Connects several transform instances into a composed one.
   *
   * Typed API.
   *
   * @param t First transform instance to compose.
   * @param ts Rest of transform instances to compose.
   * @tparam T Type of input and output.
   * @return Returns composition of input transform instances.
   */
