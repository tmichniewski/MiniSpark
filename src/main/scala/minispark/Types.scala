...
trait F0[T] extends (() => Dataset[T]) {
  ...
  @deprecated("Use F0[T].+[U](f0u: F0[U]): F0F0[T, U] and F0F0[T, U].+[V](f2tuv: F2[T, U, V]): F0[V] instead")
  def +[U, V](f0u: F0[U], f2tuv: F2[T, U, V]): F0[V] = () => f2tuv(apply(), f0u()) // F0 + (F0, F2) = F0
...
@deprecated("Use Seq(ds1, ds2,..., dsN).reduce(_ union _) instead (plain Scala only)")
